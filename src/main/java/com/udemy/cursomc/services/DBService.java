...
public class DBService {
	@Autowired
	CategoriaRepository categoriaReposiory;
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		cat1.getProdutos().addAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, 
		...
		categoriaReposiory.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "matheusgustavo2012@gmail.com", "366556535562", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("33665655", "993838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "matheus_guga2012@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("998898989", "33633636"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Av. Mattos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Av. Das Oliveiras", "336", null, "Centro", "33363633", cli2, c2);
